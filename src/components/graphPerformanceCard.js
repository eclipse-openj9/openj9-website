...
const PerformanceCard = ({ children, primary, image, heading, chartType, xAxis, yAxis }) => {
    if (chartType === "line") {
        return (
            <div
              sx={{
            ...
            >
                <h5 sx={{fontSize:"1.1rem",margin:"0.5rem 1rem 0.5rem 1rem", textAlign:"center", height:"3rem",}}>{heading}</h5>
                 <LineChart lineChartData={image} legendPosition="bottom" xAxis={xAxis} yAxis={yAxis}/>
              <div
              sx={{
        ...
        return (
            ...
            >
                <h5 sx={{fontSize:"1.1rem",margin:"0.5rem 1rem 0.5rem 1rem", textAlign:"center", height:"3rem",}}>{heading}</h5>
                <BarChart barChartData={image} xAxis={xAxis} yAxis={yAxis}/>
              <div
              sx={{
                boxShadowBottom: primary ? "cardShadow" : null,
                borderBottomRightRadius: "card",
