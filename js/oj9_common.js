...
function navigation(url) {
  ...
  if(url == "https://www.eclipse.org/openj9/docs/") document.write("<p><i class='fa fa-chevron-circle-right f_mini' aria-hidden='true'></i>Docs</p>");
  else                         document.write("<p><i class='fa fa-chevron-circle-right f_mini' aria-hidden='true'></i><a class='nav-item' href='https://www.eclipse.org/openj9/docs/' target='_blank'>Docs</a></p>");
